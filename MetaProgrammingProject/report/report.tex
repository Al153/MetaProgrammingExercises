...
\todo{\begin{itemize}
    \item I've created a back end that compiles to bytecode for a simple stack based VM.
    \item The implementation converts tagless final terms to untyped AST terms - makes optimisations easier.
    \item The AST terms have simple optimisations applied (?) and are then converted to bytecode terms.
    \item I've written a simple imperative interpreter.
    \item Would look towards a polymorphic interpreter/monadic interpreter.
    \item Uses loop unrolling
\end{itemize}}
