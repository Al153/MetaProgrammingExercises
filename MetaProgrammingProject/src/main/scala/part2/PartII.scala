...
import query.dsl.components.{FixedPoint, SimplePairs, SimpleRepetition, SingleQueries}

abstract class PartII[Err<: E: HasRecovery ] {
  ...
  = new DSL[Op, Set, FindPair, FindSingle, Findable, Path, CompletedRelation, SchemaObject] {

    import d._

    override def fixedPoint: FixedPoint[FindPair, SchemaObject] = new FixedPoint[FindPair, SchemaObject] {
    ...
    override def singleQueries: SingleQueries[FindPair, FindSingle, Findable, SchemaObject] =
      new SingleQueries[FindPair, FindSingle, Findable, SchemaObject] {
    ...
    override def simplePairs: SimplePairs[FindPair, FindSingle, SchemaObject] = new SimplePairs[FindPair, FindSingle, SchemaObject] {
    ...
    override def simpleRepetition: SimpleRepetition[FindPair, SchemaObject] =
      new SimpleRepetition[FindPair, SchemaObject] {
